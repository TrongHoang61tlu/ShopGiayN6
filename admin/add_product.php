...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_insert = "INSERT into hang(TenHang,Size,SlgTon,GiaBan,NgungBan)
            values ('$TenSanPham','$Size','$SlgTon','$Gia','$TrangThai')";
    ...
    <div class="container">
        ...
        <form class="mt-4" method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="SlgTon" class="form-control" id="SlgTon" >
            </div>
            <div class="mb-3">
                <label for="GiaBan" class="form-label">GIá Bán </label>
                <input type="text" name="GiaBan" class="form-control" id="GiaBan">
            </div>
