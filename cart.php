...
<script>
    const input_text = document.getElementsByClassName('input-text')
    const increase = document.getElementsByClassName('increase')
    const reduced = document.getElementsByClassName('reduced')

    for (let i = 0; i < increase.length; i++) {

        increase[i].onclick = function() {
            // console.log(increase[i])
            var sst = input_text[i].value;
            if (!isNaN(sst)) input_text[i].value++;
            return false;
    ...
    for (let i = 0; i < reduced.length; i++) {
        ...
        reduced[i].onclick = function() {
            var sst = input_text[i].value;
            if (!isNaN(sst)) input_text[i].value--;
            if (sst <= 0) {
                input_text[i].value = 0
            }
            return false;
        }
