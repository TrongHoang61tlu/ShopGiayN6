						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="confirmation.php">Xac</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="login.php">Đăng nhập</a></li>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="registration.php">Tạo tài khoản</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Đăng nhập với tài khoản ADMIN</h3>
						<a href="login.php">
							<button class="primary-btn">Đăng nhập với khách</button>
						</a>
						<a href="loginadmin.php">
							<button class="primary-btn">Đăng nhập admin</button>
						</a>
						<b>
							<?php
						...
						<form class="row login_form" action="./admin/login.php" method="post" id="contactForm" novalidate="novalidate">
