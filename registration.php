				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form action="./controllers/registration.php" method="POST">   
                            ...
                            <div class="col-md-12 form-group">
								<input type="password" class="form-control" id="RePassword" name="RePassword" placeholder="RePassword" onfocus="this.placeholder = ''" onblur="this.placeholder = 'RePassword'">
							</div>
							<div class="col-md-12 form-group">
